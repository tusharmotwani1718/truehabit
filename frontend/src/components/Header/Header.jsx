    ...
    >
      <div className="container mx-auto flex items-center justify-between p-4">
        ...
        <div className="md:hidden flex gap-3">
          <PrimaryButton text="Signup" classes='rounded-2xl' onClick={() => { openModal("authModalSignup") }} /> {/* Pass openModal as onClick */}
        ...
        <nav className="hidden md:flex md:items-center md:gap-7">
          ...
          <div className="flex gap-5">
            <PrimaryButton text="Signup" onClick={() => { openModal("authModalSignup") }} /> {/* Pass openModal as onClick */}
