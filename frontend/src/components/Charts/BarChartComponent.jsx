...
function BarChartComponent({
  ...
  const colors = {
    currentStats: isDarkMode ? '#9575CD' : '#673AB7',
    previousStats: isDarkMode ? '#5C6BC0' : '#261FB3',
  };
  ...
  return (
    <div className="w-full bg-background dark:bg-[#2b0051] rounded-lg shadow-xl p-5 my-6">
      ...
      <div className="flex flex-col md:flex-row gap-4">
        {/* Chart Section - Only show on md+ screens */}
        {!isMobile && (
          <div className="w-full md:w-1/2">
            <ResponsiveContainer width="100%" height={350}>
              <BarChart 
                ...
                layout="vertical"
              >
                <CartesianGrid strokeDasharray="3 3" stroke="currentColor" opacity={0.3} horizontal={false} />
                <XAxis 
                  type="number"
                  stroke="currentColor"
