  ...
  return (
    <div className="w-full rounded-lg overflow-hidden shadow-lg dark:shadow-zinc-800 flex flex-col h-full">
      ...
      <div className="flex border-b border-gray-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 sticky top-0 z-10">
        {tabs.map((tab, index) => (
          <button
            ...
            className={`px-3 sm:px-4 py-2 sm:py-3 font-medium text-xs sm:text-sm transition-colors flex-1 text-center ${activeTab === index
      ...
      <div className="flex-1 overflow-y-auto scrollbar-custom">
        <div className="p-3 sm:p-4 bg-white dark:bg-zinc-800 py-4 sm:py-6 md:py-7">
